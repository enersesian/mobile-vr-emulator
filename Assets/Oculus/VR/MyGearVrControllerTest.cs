...
public class MyGearVrControllerTest : MonoBehaviour
{
	...
	void Start()
	{
        ...
        monitors = new List<BoolMonitor>()
        {
            ...
            new BoolMonitor("Swipe Up",                         () => OVRInput.Get(OVRInput.Button.Up)),
            new BoolMonitor("Swipe Down",                       () => OVRInput.Get(OVRInput.Button.Down)),
            new BoolMonitor("Swipe Left",                       () => OVRInput.Get(OVRInput.Button.Left)),
            new BoolMonitor("Swipe Right",                      () => OVRInput.Get(OVRInput.Button.Right)),
            new BoolMonitor("--------------",                   () => OVRInput.Get(OVRInput.Button.PrimaryIndexTrigger)),
